...
if($delete_product_query){
  header("Location: Product_of_sellers.php");
                ...
                if ($product_result && mysqli_num_rows($product_result) > 0) {
                  $i = 1;
                    while ($row = mysqli_fetch_assoc($product_result)) {
                        ...
                        echo "<td><a href='Product_of_sellers.php?Did=" . $row['id'] . "' class='btn btn-danger' onclick='return confirm(\"Are you sure you want to delete this seller?\")'>Delete</a></td>";
