...
FROM orders
JOIN buyers ON orders.buyer_id = buyers.id WHERE orders.is_new = TRUE;  ");
    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0 text-dark">New orders List</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
              ...
              <tbody>
                <?php while ($row_order_query = mysqli_fetch_assoc($select_orders)) {  ?>
                  <tr>
                    ...
                    <td><a href="New_order.php?OID=<?php echo $row_order_query['id'];  ?>" class="btn btn-warning"> MarkViewed</a></td>
