    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0 text-dark">Products Approvals Lists</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
                  ...
                  $i = 1;
                    while ($row = mysqli_fetch_assoc($product_result)) {
                        ...
                        if($row['product_status']  == 'active'){
                          echo "<td><a href='Product_approvals.php?Deactive_id=" . $row['id'] . "' class='btn btn-danger'>Deactivate</a></td>";
                      
                        }
                        else{
                          echo "<td><a href='Product_approvals.php?activate_id=" . $row['id'] . "' class='btn btn-success'>Activate</a></td>";
