            ...
            <div class="sidebar-categories">
              ...
              <ul class="main-categories list-unstyled">
                <li class="filter-list">
                  <div class="dropdown">
                    <a href="#" type="button" class="btn" style="color: black;">
                    ...
                    <div class="dropdown-menu" aria-labelledby="babyDropdown">
                      <a class="dropdown-item" href="#">Baby Clothing</a>
                      <a class="dropdown-item" href="#">Kids Clothing</a>
                      <a class="dropdown-item" href="#">Blankets</a>
                      <a class="dropdown-item" href="#">Baby Toys</a>
                    </div>
                  </div>
                </li>
              ...
              <div class="row">
                <div class="col-md-6 col-lg-4">
                  <div class="card text-center card-product">
                    ...
                    <div class="card-body">
                      <p>Accessories</p>
                      <h4 class="card-product__title"><a href="Single_product.php">Quartz Belt Watch</a></h4>
